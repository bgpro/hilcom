...
class eZArchive
{
    ...
    function namedParameterList()
    {
        return array( 'ezarchive' => array( 'class_identifier' => array( 'type' => 'string',
                                                ...
                                                'parent_node_id' => array( 'type' => 'integer',
                                                                'required' => true,
                                                                'default' => 0 ),
												'timestamp_class_identifier' => array( 'type' => 'string',
                                                               'required' => false,
                                                               'default' => '' ),
																) );
    }
    ...
    function modify( $tpl, $operatorName, $operatorParameters, &$rootNamespace, &$currentNamespace, &$operatorValue, &$namedParameters )
    {
		...
		$timestamp_class_identifier = $namedParameters['timestamp_class_identifier'];
		if (!$timestamp_class_identifier){
			$timestamp_class_identifier = 'publication_date';
		}
                    ...
                    case 'mysql':
                        $SQL = "SELECT MONTH( FROM_UNIXTIME( ezcontentobject_attribute.data_int ) ) AS month,
                                ...
                                WHERE ezcontentclass_attribute.contentclass_id = ezcontentclass.id
                                    ...
                                    AND ezcontentclass_attribute.identifier = '".$timestamp_class_identifier."'
