...
<div class="content-view-full">
    <div class="class-forum-topic">
        ...
        <div class="attribute-header">
            <h1>
				<span class="impression"><a href={$node.parent.parent.url_alias|ezurl}>Forum</a></span>
				<span class="impression">/</span>
				<span class="impression"><a href={$node.parent.url_alias|ezurl}>{$node.parent.name|wash()}</a></span>
				<span class="impression">/</span>
				<span class="impression">{$node.name|wash()}</span>
			</h1>
        </div>
