...
<input class="halfbox" type="text" size="70" name="Login" id="id1" value="{$User:login|wash}" tabindex="1" />
</div>

<div class="folder">
<div class="block">
<label for="id2">{"Password"|i18n("design/ezwebin/user/login")}</label><div class="labelbreak"></div>
<input class="halfbox" type="password" size="70" name="Password" id="id2" value="" tabindex="1" />
</div>
